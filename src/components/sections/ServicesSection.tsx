...
const SERVICES = [
  {
    ...
    description:
      "Custom LLMs, autonomous agents, computer vision, and NLP systems engineered for production at enterprise scale.",
  ...
  },
  {
    ...
    title: "Cloud & DevOps",
    description:
      "Infrastructure-as-code on AWS and Azure, Kubernetes orchestration, and zero-downtime CI/CD deployment pipelines.",
  ...
  },
  {
    ...
    description:
      "React, Next.js, and Flutter applications built for speed, accessibility, and millions of concurrent users.",
  ...
  },
  {
    ...
    description:
      "Zero-trust architecture, penetration testing, SOC2 compliance automation, and continuous threat detection.",
  ...
  },
  {
    ...
    description:
      "Predictive analytics, recommendation engines, anomaly detection, and deep learning model optimization.",
  ...
  },
  {
    ...
    description:
      "RPA workflows, AI-powered process mining, and autonomous task orchestration across enterprise systems.",
